...
for i = 1:size(seqV,1)
    ...
    [vi_int(i,:,:), vi_self(i,:,:), skewRAD(i,:,:), wi, ...
            ...
            rotorCP(i,1,:), rotorCMx(i,1,:), rotorJinf(i,1,:)] ...
...
%% moment to zero 1
    ...
    [vi_int1(i,:,:), vi_self1(i,:,:), skewRAD1(i,:,:), wi1, rotorAngINFLOW1(i,1,:), ...
            ...
            rotorJinf1(i,1,:)] = fcnPREDICTRPM(flowq(i,1),flowRHO,...
    ...
    [ momentROTORTHRUST1(i,:,:), momentROTORPx1(i,:,:), momentROTORPy1(i,:,:), ...
            ...
            momentLIFTBODY1(i,:,:), momentDRAGBODYinduced1(i,:,:), momentTOTAL1(i,:) ] ...
            = fcnCALCMOMENTS(massMOTOR, massARM, massLEG, massPAYLOAD, massBODY, ...
            positionROTOR, positionMOTOR, positionARM, ...
            positionLEG, positionBODY, positionPAYLOAD,...
            dragVEHICLE(i,1), dragARM(i,1), dragLEG(i,1), ...
...
%% moment to zero 2
 ...
 [vi_int2(i,:,:), vi_self2(i,:,:), skewRAD2(i,:,:), wi2, rotorAngINFLOW2(i,1,:),...
            ...
            rotorJinf2(i,1,:)] = fcnPREDICTRPM(flowq(i,1),flowRHO,...
 ...
 [powerROTOR2(i,1,:), powerTOTAL2(i,1,:), powerVEHICLE2(i,1)] = fcnROTORPOWER (flowRHO, geomDIAMETER,...
    ...
    [ momentROTORTHRUST2(i,:,:), momentROTORPx2(i,:,:), momentROTORPy2(i,:,:), ...
            ...
            momentLIFTBODY2(i,:,:), momentDRAGBODYinduced2(i,:,:), momentTOTAL2(i,:) ] ...
            = fcnCALCMOMENTS(massMOTOR, massARM, massLEG, massPAYLOAD, massBODY, ...
            positionROTOR, positionMOTOR, positionARM, ...
            positionLEG, positionBODY, positionPAYLOAD,...
            dragVEHICLE(i,1), dragARM(i,1), dragLEG(i,1), ...
...
%% TOTALS - First
momentTOTALROTORFORCES = momentROTORTHRUST(:,2,1)+momentROTORTHRUST(:,2,2)+ ...
                    momentROTORTHRUST(:,2,3)+momentROTORTHRUST(:,2,4)+ ...
                    momentROTORPx(:,2,1)+momentROTORPx(:,2,2)+ ...
                    momentROTORPx(:,2,3)+momentROTORPx(:,2,4)+ ...
                    momentROTORPy(:,2,1)+momentROTORPy(:,2,2)+ ...
                    momentROTORPy(:,2,3)+momentROTORPy(:,2,4);
                  
momentTOTALROTORMOMENTS = momentROTORMx(:,2,1)+momentROTORMx(:,2,2)+ ...
                    momentROTORMx(:,2,3)+momentROTORMx(:,2,4)+ ...
                    momentROTORMy(:,2,1)+momentROTORMy(:,2,2)+ ...
                    momentROTORMy(:,2,3)+momentROTORMy(:,2,4);
              
momentTOTALDRAG =  momentDRAGMOTOR(:,2,1)+momentDRAGMOTOR(:,2,2)+...
                   momentDRAGMOTOR(:,2,3)+momentDRAGMOTOR(:,2,4)+...
                   momentDRAGARM(:,2,1)+momentDRAGARM(:,2,2)+...
                   momentDRAGARM(:,2,3)+momentDRAGARM(:,2,4)+...
                   momentDRAGLEG(:,2,1)+momentDRAGLEG(:,2,2)+...
                   momentDRAGLEG(:,2,3)+momentDRAGLEG(:,2,4)+...
                   momentDRAGBODY(:,:,2)+momentDRAGPAYLOAD(:,:,2)+...
                   momentDRAGBODYinduced(:,:,2);

momentTOTALWEIGHTS = momentWEIGHTMOTOR(:,2,1)+momentWEIGHTMOTOR(:,2,2)+...
                   momentWEIGHTMOTOR(:,2,3)+momentWEIGHTMOTOR(:,2,4)+...
                   momentWEIGHTARM(:,2,1)+momentWEIGHTARM(:,2,2)+...
                   momentWEIGHTARM(:,2,3)+momentWEIGHTARM(:,2,4)+...
                   momentWEIGHTLEG(:,2,1)+momentWEIGHTLEG(:,2,2)+... 
                   momentWEIGHTLEG(:,2,3)+momentWEIGHTLEG(:,2,4)+...
                   momentWEIGHTBODY(:,:,2)+momentWEIGHTPAYLOAD(:,:,2);

momentTOTALLIFTBODY = momentLIFTBODY(:,:,2);
...
%% LAST TOTALS
momentTOTALROTORFORCES2 = momentROTORTHRUST2(:,2,1)+momentROTORTHRUST2(:,2,2)+ ...
                    momentROTORTHRUST2(:,2,3)+momentROTORTHRUST2(:,2,4)+ ...
                    momentROTORPx2(:,2,1)+momentROTORPx2(:,2,2)+ ...
                    momentROTORPx2(:,2,3)+momentROTORPx2(:,2,4)+ ...
                    momentROTORPy2(:,2,1)+momentROTORPy2(:,2,2)+ ...
                    momentROTORPy2(:,2,3)+momentROTORPy2(:,2,4);
                  
momentTOTALROTORMOMENTS2 = momentROTORMx2(:,2,1)+momentROTORMx2(:,2,2)+ ...
                    momentROTORMx2(:,2,3)+momentROTORMx2(:,2,4)+ ...
                    momentROTORMy2(:,2,1)+momentROTORMy2(:,2,2)+ ...
                    momentROTORMy2(:,2,3)+momentROTORMy2(:,2,4);
              
momentTOTALDRAG2 =  momentDRAGMOTOR2(:,2,1)+momentDRAGMOTOR2(:,2,2)+...
                   momentDRAGMOTOR2(:,2,3)+momentDRAGMOTOR2(:,2,4)+...
                   momentDRAGARM2(:,2,1)+momentDRAGARM2(:,2,2)+...
                   momentDRAGARM2(:,2,3)+momentDRAGARM2(:,2,4)+...
                   momentDRAGLEG2(:,2,1)+momentDRAGLEG2(:,2,2)+...
                   momentDRAGLEG2(:,2,3)+momentDRAGLEG2(:,2,4)+...
                   momentDRAGBODY2(:,:,2)+momentDRAGPAYLOAD2(:,:,2)+...
                   momentDRAGBODYinduced2(:,:,2);

momentTOTALWEIGHTS2 = momentWEIGHTMOTOR2(:,2,1)+momentWEIGHTMOTOR2(:,2,2)+...
                   momentWEIGHTMOTOR2(:,2,3)+momentWEIGHTMOTOR2(:,2,4)+...
                   momentWEIGHTARM2(:,2,1)+momentWEIGHTARM2(:,2,2)+...
                   momentWEIGHTARM2(:,2,3)+momentWEIGHTARM2(:,2,4)+...
                   momentWEIGHTLEG2(:,2,1)+momentWEIGHTLEG2(:,2,2)+... 
                   momentWEIGHTLEG2(:,2,3)+momentWEIGHTLEG2(:,2,4)+...
                   momentWEIGHTBODY2(:,:,2)+momentWEIGHTPAYLOAD2(:,:,2);

momentTOTALLIFTBODY2 = momentLIFTBODY2(:,:,2);
...
figure;
plot(flowV, momentTOTALROTORFORCES,'--b+',...
    flowV, momentTOTALROTORMOMENTS,'--ro',...
    flowV, momentTOTALDRAG,':rs',...
    flowV, momentTOTALLIFTBODY,'-.kh',...
    flowV, momentTOTALWEIGHTS, '-gd')
hold on
...
% Weights - from components
figure;
plot(flowV, momentTOTALROTORFORCES2,'--b+',...
    flowV, momentTOTALROTORMOMENTS2,'--ro',...
    flowV, momentTOTALDRAG2,':rs',...
    flowV, momentTOTALLIFTBODY2,'-.kh',...
    flowV, momentTOTALWEIGHTS2, '-gd')
hold on
...
% Weights - from components
figure;
plot(flowV, gradmomentFORCES,'--b+',...
    flowV, gradmomentMOMENTS,'--ro',...
    flowV, gradmomentDRAG,':rs',...
    flowV, gradmomentLIFT,'-.kh',...
    flowV, gradmomentWEIGHTS, '-gd')
hold on
...
% Weights - from components
figure;
plot(flowV, gradmomentFORCES2,'--b+',...
    flowV, gradmomentMOMENTS2,'--ro',...
    flowV, gradmomentDRAG2,':rs',...
    flowV, gradmomentLIFT2,'-.kh',...
    flowV, gradmomentWEIGHTS2, '-gd')
hold on
