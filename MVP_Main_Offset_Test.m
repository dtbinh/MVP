...
%% moment to zero 2
 ...
 [vi_int2(i,:,:), vi_self2(i,:,:), skewRAD2(i,:,:), wi2, rotorAngINFLOW2(i,1,:),...
            rotorVelINFLOW2(i,1,:), rotorRPM2_nopayload(i,1,:), rotorPx2(i,1,:), rotorPy2(i,1,:),...
 ...
 [powerROTOR2_nopayload(i,1,:), powerTOTAL2_nopayload(i,1,:), powerVEHICLE2_nopayload(i,1)] = fcnROTORPOWER (flowRHO, geomDIAMETER,...
            geomNumROTORS, rotorCP2(i,1,:), rotorRPM2_nopayload(i,1,:), powerPARASITIC(i,1));

    [ momentROTORTHRUST2_nopayload(i,:,:), momentROTORPx2_nopayload(i,:,:), momentROTORPy2_nopayload(i,:,:), ...
            momentROTORMx2_nopayload(i,:,:), momentROTORMy2_nopayload(i,:,:), momentWEIGHTMOTOR2_nopayload(i,:,:),...
            momentWEIGHTARM2_nopayload(i,:,:), momentDRAGMOTOR2_nopayload(i,:,:), momentDRAGARM2_nopayload(i,:,:),...
            momentWEIGHTLEG2_nopayload(i,:,:), momentDRAGLEG2_nopayload(i,:,:), momentWEIGHTBODY2_nopayload(i,:),...
            momentWEIGHTPAYLOAD2_nopayload(i,:), momentDRAGBODY2_nopayload(i,:), momentDRAGPAYLOAD2_nopayload(i,:),...
            momentLIFTBODY2_nopayload(i,:), momentDRAGBODYinduced2_nopayload(i,:), momentWEIGHTOFFSET2_nopayload(i,:), momentTOTAL2_nopayload(i,:) ] ...
            = fcnCALCMOMENTS(massMOTOR, massARM, massLEG, massPAYLOAD, massBODY, massOFFSET,...
            positionROTOR, positionMOTOR, positionARM, ...
            positionLEG, positionBODY, positionPAYLOAD, positionOFFSET,...
            dragVEHICLE(i,1), dragARM(i,1), dragLEG(i,1), ...
...
save('Nov08_nopayloadHawk.mat', 'flowV', 'momentROTORTHRUST2_nopayload', 'momentROTORPx2_nopayload', 'momentROTORPy2_nopayload', ...
            'momentROTORMx2_nopayload', 'momentROTORMy2_nopayload', 'momentWEIGHTMOTOR2_nopayload',...
            'momentWEIGHTARM2_nopayload', 'momentDRAGMOTOR2_nopayload', 'momentDRAGARM2_nopayload',...
            'momentWEIGHTLEG2_nopayload', 'momentDRAGLEG2_nopayload', 'momentWEIGHTBODY2_nopayload',...
            'momentWEIGHTPAYLOAD2_nopayload', 'momentDRAGBODY2_nopayload', 'momentDRAGPAYLOAD2_nopayload',...
            'momentLIFTBODY2_nopayload', 'momentDRAGBODYinduced2_nopayload', 'momentWEIGHTOFFSET2_nopayload', 'momentTOTAL2_nopayload',...
            'powerROTOR2_nopayload', 'powerTOTAL2_nopayload', 'powerVEHICLE2_nopayload','rotorRPM2_nopayload')
...
% Mass offset with position
    ...
    x=-0.2651; %kg
positionOFFSET = [x, 0, 0]; %on right arm near rotor 2
massVEHICLE = massVEHICLE + massOFFSET - massPAYLOAD;
...
%% moment to zero 2
 ...
 [powerROTOR2_withoffset(i,1,:), powerTOTAL2_withoffset(i,1,:), powerVEHICLE2_withoffset(i,1)] = fcnROTORPOWER (flowRHO, geomDIAMETER,...
    ...
    [ momentROTORTHRUST2_withoffset(i,:,:), momentROTORPx2_withoffset(i,:,:), momentROTORPy2_withoffset(i,:,:), ...
            ...
            momentLIFTBODY2_withoffset(i,:), momentDRAGBODYinduced2_withoffset(i,:), momentWEIGHTOFFSET2_withoffset(i,:), momentTOTAL2_withoffset(i,:) ] ...
            = fcnCALCMOMENTS(massMOTOR, massARM, massLEG, massPAYLOAD, massBODY, massOFFSET,...
            positionROTOR, positionMOTOR, positionARM, ...
            positionLEG, positionBODY, positionPAYLOAD, positionOFFSET,...
            dragVEHICLE(i,1), dragARM(i,1), dragLEG(i,1), ...
...
str1 = sprintf('_mass_%.3fkg',massOFFSET);
str2 = sprintf('__x_%.3fm',x);
str3 = '.mat';
fname = strcat('Nov08_HAWKoffset',str1,str2,str3);
...
% 
%  [vi_int2(i,:,:), vi_self2(i,:,:), skewRAD2(i,:,:), wi2, rotorAngINFLOW2(i,1,:),...
%             rotorVelINFLOW2(i,1,:), rotorRPM2_withpayload(i,1,:), rotorPx2(i,1,:), rotorPy2(i,1,:),...
%             rotorMx2(i,1,:), rotorMy2(i,1,:), rotorCP2(i,1,:), rotorCMx2(i,1,:),...
%             rotorJinf2(i,1,:),vi_int_total2(i,:,:),vi_z2(i,:,:),vi_int_only2(i,:,:), AngINT2(i,:,:),magvi_int_only2(i,:,:)] = fcnPREDICTRPM(flowq(i,1),flowRHO,...
%             geomNumROTORS,geomNumBLADES,geomDIAMETER, positionROTOR,...
%             rotorTHRUST2(i,1,:),rotorRPM2(i,1,:),rotorAngINFLOW2(i,1,:),rotorVelINFLOW2(i,1,:),...
...
% 
% 
%  [powerROTOR2_withpayload(i,1,:), powerTOTAL2_withpayload(i,1,:), powerVEHICLE2_withpayload(i,1)] = fcnROTORPOWER (flowRHO, geomDIAMETER,...
%             geomNumROTORS, rotorCP2(i,1,:), rotorRPM2_withpayload(i,1,:), powerPARASITIC(i,1));
% 
%     [ momentROTORTHRUST2_withpayload(i,:,:), momentROTORPx2_withpayload(i,:,:), momentROTORPy2_withpayload(i,:,:), ...
%             momentROTORMx2_withpayload(i,:,:), momentROTORMy2_withpayload(i,:,:), momentWEIGHTMOTOR2_withpayload(i,:,:),...
%             momentWEIGHTARM2_withpayload(i,:,:), momentDRAGMOTOR2_withpayload(i,:,:), momentDRAGARM2_withpayload(i,:,:),...
%             momentWEIGHTLEG2_withpayload(i,:,:), momentDRAGLEG2_withpayload(i,:,:), momentWEIGHTBODY2_withpayload(i,:),...
%             momentWEIGHTPAYLOAD2_withpayload(i,:), momentDRAGBODY2_withpayload(i,:), momentDRAGPAYLOAD2_withpayload(i,:),...
%             momentLIFTBODY2_withpayload(i,:), momentDRAGBODYinduced2_withpayload(i,:), momentWEIGHTOFFSET2_withpayload(i,:), momentTOTAL2_withpayload(i,:) ] ...
%             = fcnCALCMOMENTS(massMOTOR, massARM, massLEG, massPAYLOAD, massBODY, massOFFSET,...
%             positionROTOR, positionMOTOR, positionARM, ...
%             positionLEG, positionBODY, positionPAYLOAD, positionOFFSET,...
%             dragVEHICLE(i,1), dragARM(i,1), dragLEG(i,1), ...
...
% end
% 
% save('Oct17withpayload.mat', 'flowV', 'momentROTORTHRUST2_withpayload', 'momentROTORPx2_withpayload', 'momentROTORPy2_withpayload', ...
%             'momentROTORMx2_withpayload', 'momentROTORMy2_withpayload', 'momentWEIGHTMOTOR2_withpayload',...
%             'momentWEIGHTARM2_withpayload', 'momentDRAGMOTOR2_withpayload', 'momentDRAGARM2_withpayload',...
%             'momentWEIGHTLEG2_withpayload', 'momentDRAGLEG2_withpayload', 'momentWEIGHTBODY2_withpayload',...
%             'momentWEIGHTPAYLOAD2_withpayload', 'momentDRAGBODY2_withpayload', 'momentDRAGPAYLOAD2_withpayload',...
%             'momentLIFTBODY2_withpayload', 'momentDRAGBODYinduced2_withpayload', 'momentWEIGHTOFFSET2_withpayload', 'momentTOTAL2_withpayload',...
%             'powerROTOR2_withpayload', 'powerTOTAL2_withpayload', 'powerVEHICLE2_withpayload','rotorRPM2_withpayload')
% 
% clear 
% clc