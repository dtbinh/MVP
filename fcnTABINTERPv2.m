function [ valRPM, valPx_rho, valPy_rho, valMx_rho, valMy_rho, valQ_rho, valCP, valCMx, valJinf ] = fcnTABINTERPv2( vecRPM, alpha, tabLOOKUP, flowq, valTHRUSTrho )
...
for i = 1:length(vecRPM)
    ...
    vecQ(i) = interp1(tempq,tempQ,flowq)';
...
valQ_rho=interp1(vecRPM',vecQ,valRPM,'linear','extrap');
