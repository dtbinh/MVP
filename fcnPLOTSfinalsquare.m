...
figure;
plot(flowV, rotorRPM2(:,:,1),'-ro', flowV, rotorRPM2(:,:,2),'-b+',...
    flowV, rotorRPM2(:,:,3),'-ks',flowV, rotorRPM2(:,:,4),'-gx')
title('Rotor RPM vs Airspeed (Moment Trim)')
xlabel('Airspeed [m/s]')
ylabel('Rotor RPM')
legend('Lead','Rear','Rear','Lead','Location','northwest')
...
legend('Vehicle Pitch','Rotor 1 - Lead','Rotor 2 - Left','Rotor 3 - Rear','Rotor 4 - Right','Location','southeast')
xlabel('Airspeed [m/s]')
